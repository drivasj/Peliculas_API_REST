...
namespace Peliculas_Api
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // representa relacion muchos a muchos 
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var username = "dn1794_14@hotmail.com";
            ...
            modelBuilder.Entity<SalaDeCine>()
              ...
              {
                    new SalaDeCine{Id = 2, Nombre = "Agora", Ubicacion = geometryFactory.CreatePoint(new Coordinate(-69.9388777, 18.4839233))},
